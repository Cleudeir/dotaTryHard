...
export default function FriendsGamed({friendsGamed}) {
  const [useData, setData] = useState(friendsGamed);
  const [useSave] = useState(friendsGamed);
  ...
  return (
    ...
    <div style={{display: 'flex', flexDirection: 'column', maxWidth: 500, marginLeft: 'auto', marginRight: 'auto', marginTop: 100}} >
      ...
      { useLoading &&
      <>
        <h1 style={{marginLeft: 'auto', textAlign: 'center'}} >See Your win Rate<br />
                with<br /> your friends</h1>
